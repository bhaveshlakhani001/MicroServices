package com.vedity.microservices.VaccinationCenter.controllers;
...
import com.vedity.microservices.VaccinationCenter.Model.Citizen;
import com.vedity.microservices.VaccinationCenter.Model.RequiredResponse;
import com.vedity.microservices.VaccinationCenter.Repos.CenterRepo;
...
public class VaccinationCenterController {
	...
	@PostMapping(path ="vaccinationcenter/add")
	...
	@GetMapping(path = "vaccinationcenter/id/{id}")
	public ResponseEntity<RequiredResponse> getAllDadaBasedonCenterId(@PathVariable Integer id){
		...
		java.util.List<Citizen> listOfCitizens = restTemplate.getForObject("http://CITIZEN-SERVICE/api/citizen/"+id, List.class);
